...
void paso4_ingreso_cordenadas()
{
    ...
    int fila, columna = 0;
    Console.Clear();
    //EN ESTA PARTE VOLVEMOS A REPRESENTAR LA TABLA PERO CON LOS VARCOS RESTANTES
    ...
    do
    {
        ...
        // delimitar el rango de tiro
        if (fila < 0 || fila > 4 || columna < 0 || columna > 4)
        {
            Console.WriteLine("Coordenadas fuera de los límites del tablero. Por favor, selecciona otras coordenadas.");
        }
        else
